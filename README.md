...
| **`courses/`** | **Adult classes** — who signed up, places left, who is waiting, and **the classes themselves**: create one, open or close sign-ups, rename, change how many places there are. |
| **`classpages/`** | **What a class says** — the wording on each class's own page: the opening paragraph, the what-to-know list, the session labels, the experience question, and the wording shown when sign-ups are shut. |
...
rates/    classpages/
                        ...
                        times/, notices/, rates/ and classpages/ are the
                        committee's editors — all four described below.

admin/   what those sixteen pages SHARE.
