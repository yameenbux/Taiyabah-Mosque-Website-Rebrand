-- ===========================================================================
--  004_courses.sql — classes and workshops, and the people signed up to them
--
...
--
--  This replaces an earlier 004_arabic_classes.sql that was never applied.
...
--
--  Much lighter than 003_admissions.sql: adult names, emails and phone
