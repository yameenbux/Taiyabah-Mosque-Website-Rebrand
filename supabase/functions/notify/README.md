...
This is the less-travelled path. Supabase's own guide for sending mail
...
one.com gives no delivery reporting. A message accepted by their server
...
The credential is a mailbox password, not a send-only key. It must be
