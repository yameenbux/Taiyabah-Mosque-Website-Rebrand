// ===========================================================================
//  *** DO NOT DEPLOY THIS FILE. IT IS TWO GENERATIONS OUT OF DATE. ***
//
//  14 September 2026. This copy predates donations entirely: no DN- prefix,
//  no Gift Aid, no record_donation_paid, no giftaid.ts. The function that is
//  actually running in Supabase has all of those, plus the donate-page
//  handling added today.
//
//  Deploying what is below would silently remove every donation path and the
//  masjid would stop recording card giving again, with no error anywhere.
//
//  The live source is in this folder as index.ts. This file is kept only so
//  that the gap is visible in the history rather than discovered by someone
//  deploying it.
//
//  THE REAL LESSON: this repository has now been caught three times holding a
//  copy that does not match production — donations (022) has no migration
//  file at all, notices has none, and this function was two versions behind.
//  Anything deployed from a dashboard has to be written back here the same
//  day or it is not really under version control.
// ===========================================================================
